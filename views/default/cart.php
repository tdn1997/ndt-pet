			...
			<form action="client/order" method="GET">
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							<td><img src="/nguyen-duy-thuan/images/uploads/<?php echo $data[$i]['anhchinh']; ?>" data-masp='<?php echo $data['masp'] ?>[]' style="width: 80px"></td>
							<td><?php echo $data[$i]['tensp'] ?></td>
							<td class="prices" data-price='<?php echo $data[$i]['gia']?>'><?php echo number_format($data[$i]['gia']) ?></td>
