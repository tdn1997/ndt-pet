		...
		<div class="col-sm-4">
			...
			<form action="client/order" method="GET">
				<table class="table" style="font-size: 14px; background-color: #eaeaea">
					...
					<tbody>
						<tr>
							<td><img src="/nguyen-duy-thuan/images/uploads/<?php echo $data['anhchinh']; ?>" class='sanpham' data-masp='<?php echo $data['masp'] ?>' style="width: 80px"></td>
							<td><?php echo $data['tensp'] ?></td>
							<td class="prices" data-price='<?php echo $data['gia']; ?>'><?php echo number_format($data['gia']) ?></td>
