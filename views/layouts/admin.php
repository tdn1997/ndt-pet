...
<head>
  ...
  <title>NDT.Phone | AdminPage</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="modal" id="modalThongBaoAdmin" tabindex="-1">
    <div class="modal-dialog modal-custom">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Thông báo</h5>
        </div>
        <div id="modalThongBaoAdminBody" class="modal-body">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="indexadmin/Dashboard" class="logo">
        ...
        <span class="logo-lg"><b>NDT</b>.Phone | <b>Admin</b></span>
      </a>
    ...
    function logout(){
      $.ajax({
        ...
        success : function (result){
          location.replace('http://localhost:8010/nguyen-duy-thuan/indexadmin');
        }
      });
    }
  </script>
