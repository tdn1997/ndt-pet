...
<html lang="en">
<head>
	<title> NDT.Phone - Ở đây bán điện thoại bao mắc! </title>
	<meta charset="utf-8">
	<base href="/nguyen-duy-thuan/">
...
<body>
	<!-- Modal -->
	<div class="modal fade" id="appModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modalThongBaoProdsLabel">Thông báo</h5>					
				</div>
	...
	<header id='header'>
		<a href=""><img src="public/images/logo.png"><h2 class="logo">NDT.Phone</h2></a>
		...
		<div class="header-detail">
			<p>Số 586 Kha Vạn Cân, Phường Linh Đông, TP. Thủ Đức, Thành Phố Hồ Chí Minh<br />
	...
	<nav class="navbar navbar-default" role="navigation" id="nav">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="">NDT.Phone</a>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<form action="#" id="searchForm" class="navbar-form navbar-right searchbox-desktop">
					...
					<button class="btn btn-primary" type="submit" id="searchBtn">Tìm</button>
				</form>
			</div><!-- /.navbar-collapse -->
		</div>
	</nav>
	...
	<footer>
		<div class="container-fluid">
			<div class="row">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31350.526512688404!2d106.71085152020534!3d10.825403106442788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528ec086312f5%3A0xefc04067c14b741a!2zVHLGsOG7nW5nIENhbyDEkOG6s25nIEPDtG5nIE5naMOqzKMgVFAuSENN!5e0!3m2!1svi!2s!4v1621681639123!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
				</div>
				<div class="col-lg-4" id="contact">
					<h3>Contact</h3>
					<i class="glyphicon glyphicon-map-marker"></i><span>Linh Đông, TP. Thủ Đức, Thành Phố Hồ Chí Minh</span><br>
					<i class="glyphicon glyphicon-earphone"></i><span> (028) 3897 0160</span><br>
					<i class="glyphicon glyphicon-envelope"></i><span> NDT.Phone@gmail.com</span><br>
					...
					<form action="" method="POST" class="form-inline" role="form">
						...
						<span class="btn btn-primary" onclick="showAppModalBody('Bạn sẽ nhận được thông báo của chúng tôi khi có ưu đãi mới!')">Gửi</span>
					</form>
				</div>
				<div class="col-lg-12" id="copyright-txt">
					<b>All right reverse, &#169; copyright of nguyen-duy-thuan.com</b>
				</div>
			</div>
		</div>
	</footer>
	...
	<script>
		function showAppModalBody(str){
			$('#appModalBody').text(str); 
			$('#appModal').modal('show');
		}
	</script>
</body>
